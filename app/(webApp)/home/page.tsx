...
const page = () => {
  ...
  return (
    <div className="flex sm:items-center pn:max-sm:items-start justify-center w-full h-full">
      <div className="sm:w-full flex flex-col items-center p-4 sm:justify-center pn:max-sm:p-0 pn:max-sm:h-auto pn:max-sm:overflow-y-auto no-scrollbar">
        <div className="sm:w-full  flex flex-col  sm:pb-4 pt-20 sm:pt-0  justify-center items-center">
          ...
          <div className="text-[16px] text-[#616161]">
            Ready to create your own relmes
          </div>
        </div>
        {/* Top Search */}
        <div className="text-[15px] vs:scale-[0.5] ss:scale-[0.6] pp:scale-[0.8] sm:scale-[1] origin-center transition-transform duration-300 justify-center flex items-center gap-4  p-2 text-[#364141] ">
          <div className="relative bg-white rounded-[30px] overflow-hidden w-[662px] border border-[#f4f4f4da] h-[240px]">
            ...
            <div className="absolute inset-0  space-y-1 h-fit  flex flex-col gap-1 p-4 text-white">
              ...
              <Link
                href="../serverCreation"
                className="h-[50px] font-space-grotesk w-[280px] p-2 flex items-center justify-center  outline-none text-[15px] bg-[#FDD78D] rounded-[20px] text-[#364141] "
              >
        ...
        {results.length > 0 && (
          <div className="absolute top-13 w-[75%] mt-2 bg-white border border-gray-200 rounded-xl shadow-md z-50 max-h-[300px] overflow-y-auto">
            {results.map((server) => (
              <div
                key={server._id}
              ...
              >
                ...
                <button
                  ...
                  className=" h-[30px] bg-blue-500 hover:bg-blue-400 text-white px-2 rounded-xl flex justify-center self-center items-center text-[10px]"
                >
                  Contribute
                </button>
              </div>
