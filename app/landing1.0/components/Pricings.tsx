...
function Pricings() {
  return (
    <div className="w-full h-[90vh] flex flex-row items-center justify-center px-8 py-16">
      {/* Left side - Text content */}
      <div className="w-1/2 flex flex-col justify-center pr-12">
        <h1 className="text-5xl font-bold text-[#3F3F3F] mb-6">Pricings</h1>
        <p className="text-lg text-[#3F3F3F] leading-relaxed max-w-lg">
          Throughout your customer's entire buying journey, Razor AI allow you
      ...
      <div className="w-1/2 flex items-center justify-center relative">
        <svg
          ...
          className="w-full h-full max-w-[932px] max-h-[553px]"
        >
